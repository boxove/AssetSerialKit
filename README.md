# AssetSerialKit 一款面向 Windows 电脑资产盘点的轻量级序列号采集工具

它通过批处理和 PowerShell 一键采集本机或内网多台电脑的主机、显示器、硬盘、主板、内存、网络、系统、BitLocker、Windows 激活状态等信息，并自动导出为 TXT、CSV、TSV 格式，方便在 Excel 中查看、汇总和留档。适用于企业 IT 运维、设备入库盘点、资产巡检和批量信息统计场景。
